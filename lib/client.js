window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      ".dshdb-crumb{display:flex;align-items:center;gap:2px;flex-wrap:wrap;flex:1;min-width:0;font-size:12px;color:var(--dsw-alias-label-secondary,#9a9a9a)}",
      ".dshdb-seg{border:0;background:transparent;color:var(--dsw-alias-label-secondary,#9a9a9a);font:inherit;font-size:12px;cursor:pointer;padding:2px 4px;border-radius:6px}",
